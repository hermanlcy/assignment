# this algorithm is applicable to mission 1, 2, 4, 10, 18, 20, 27, 32, 38, 42, 47
import random
...
# Player_card function ask the player to give a card based on the color condition
def Player_card13(player, color):
    card = ''
    if color == "Rocket":
        if len(player.Rocket) != 0:
            card = random.choice(player.Rocket)
...
# Player_card function ask the player to give a card based on the color condition
def Player_card44(player, color):
    card = ''
    if color == "Rocket":
        if len(player.Rocket) != 0:
            card = random.choice(player.Rocket)
...
def Player_round(players, leader, num_round, desk, judge_task, num_of_player, mission, communicated):
    Leader_color = ""
