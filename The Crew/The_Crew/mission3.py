# this algorithm is applicable to mission 3, 8, 11, 19, 21, 23, 31
import random
...
# mission3 test
def Player_round3(players, leader, num_round, desk, judge_task, num_of_player, priority_list, priority_index, mission, communicated):
    ...
    for single_trick_card in players[leader].win_cards:
        for single_task_card in players[leader].task:
            if single_task_card == single_trick_card:
                ...
                print "Number", priority_index, "priority_task:", priority_list[priority_index]
                # print "single_task_card", single_task_card
    ...
    if priority_fail == True:
        print "Task Priority failed, Mission failed"
        ...
        if len(judge_task) == 0:
            ...
            if num_round == (40 / num_of_player + 1):
                ...
                Player_round3(players, leader, num_round, desk, judge_task, num_of_player, priority_list, priority_index, mission, communicated)
