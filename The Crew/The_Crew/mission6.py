# this algorithm is applicable to mission 6, 14, 22, 25, 30, 39
import random
from mission1 import *



# mission6 test with out communication 
def Player_round6(players, leader, num_round, desk, judge_task, num_of_player, priority_list, priority_index, mission, communicated):
    ...
    for single_trick_card in players[leader].win_cards:
        for single_task_card in players[leader].task:
            if single_task_card == single_trick_card:
                ...
                if (single_task_card in priority_list):
